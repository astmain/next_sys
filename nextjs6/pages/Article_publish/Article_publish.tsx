...
export default function Article_publish() {
  useSnapshot(BUS)
  ...
  return (
    <div>
      ...
      <Card>
        <Form ref={form_ref} onSubmit={handle_publish} layout="vertical" style={{ maxWidth: 800 }}>
          ...
          <Form.Item label="文章内容" field="content" rules={[{ required: true, message: '请输入文章内容' }]}>
            <Input.TextArea placeholder="请输入文章内容" rows={15} style={{ resize: 'vertical' }} />
          </Form.Item>
