  ...
  return (
    <div>
      ...
      <Card>
        <Table
          columns={columns}
          data={snap.data.articles}
          rowKey="id"
          pagination={{
            total: snap.data.articles.length,
            pageSize: 10,
            showTotal: true
          }}
        />
      ...
      <Modal
        title="查看文章"
        visible={view_modal_visible}
        onCancel={() => set_view_modal_visible(false)}
        footer={null}
        style={{ width: 800 }}
      >
        {viewing_article && (
          <div>
            ...
            <div style={{ marginBottom: 16, color: '#666' }}>
              ...
              <span style={{ marginLeft: 20 }}>
                发布时间: {new Date(viewing_article.createdAt).toLocaleString()}
              </span>
            </div>
            <div style={{ 
              lineHeight: 1.8, 
